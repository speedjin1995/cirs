				...
				<div class="card mt-4">
					<div class="card-header">
                        <div class="row">
                            <div class="col-8"></div>
                            <div class="col-2">
                                <button type="button" class="btn btn-block btn-sm bg-gradient-danger" id="multiDeactivate" data-bs-toggle="tooltip" title="Delete Load Cell"><i class="fa-solid fa-ban"></i> Delete Load Cell</button>
                            </div>
                            <div class="col-2">
                                <button type="button" class="btn btn-block btn-sm bg-gradient-warning" id="addBrand"><i class="fa-solid fa-circle-plus"></i> Add Load Cell</button>
                            </div>
                        </div>
                    </div>
					<div class="card-body">
    ...
    $('#multiDeactivate').on('click', function () {
        ...
        if (selectedIds.length > 0) {
            if (confirm('Are you sure you want to cancel these items?')) {
                $.post('php/deleteLoadCell.php', {userID: selectedIds, type: 'MULTI'}, function(data){
                    var obj = JSON.parse(data);
            ...
            alert("Please select at least one load cell to delete.");
            $('#spinnerLoading').hide();
        }     
    });
});
