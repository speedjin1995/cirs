...
$sel = mysqli_query($db,"select count(*) as allcount FROM other_validations WHERE status = 'Pending'".$searchQuery);
$records = mysqli_fetch_assoc($sel);
$totalRecordwithFilter = $records['allcount'];

## Fetch records
$validationQuery = "SELECT * FROM other_validations WHERE status = 'Pending'".$searchQuery." order by ".$columnName." ".$columnSortOrder." limit ".$row.",".$rowperpage;
