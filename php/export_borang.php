                                    ...
                                    <td style="vertical-align: right;" width="40%">
                                        ...
                                        <table class="table-bordered">
                                            ...
                                            foreach ($jenisAlatData as $key => $value) {
                                                ...
                                                $message .= '<tr><td>'.$key.'</td><td>'.$alatCount.'</td><td>RM '.number_format($alatTotalPrice, 2, '.', '').'</td>';
                                                $count += $alatCount;
                                                $totalPrice += $alatTotalPrice;
                                            }
                                    $message .= '<tr><td>Jumlah</td><td>'.$count.'</td><td>RM '. number_format(floatval($totalPrice), 2, '.', '') .'</td></tr></tbody>
                                        </table>
                                    </td>
                                </tr>
                            </tbody>
