        ...
        if (! $update_stmt->execute()) {
            ...
            if ($row = $result->fetch_assoc()) {
                ...
                if($format == 'EXPANDABLE'){
                    ...
                    $message['certFilePath1'] = $row['cert_file_path1'];
                    $message['certFilePath2'] = $row['cert_file_path2'];
                    $message['certFilePath3'] = $row['cert_file_path3'];
                    $message['certFilePath4'] = $row['cert_file_path4'];
                    $message['certFilePath5'] = $row['cert_file_path5'];
