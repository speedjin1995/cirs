...
if(isset($_GET['userID'], $_GET["file"], $_GET["validator"], $_GET['actualPrintDate'], $_GET['status'])){
    ...
    if($file == 'ATK' && $validator == 'METROLOGY'){
            ...
            if ($res = $result->fetch_assoc()) {
                ...
                if(count($btuBoxInfo) > 0){
                    foreach ($btuBoxInfo as $btuBox){
                        ...
                        $fileName = "filled_metrology_".$_GET['file']."_form_{$btuBox['no']}.pdf"; 
                        $outputPath = $tempBtuBoxDir . DIRECTORY_SEPARATOR . $fileName;
                        $pdf->Output('F', $outputPath);
                        $btuBoxFilePath[] = $outputPath;
                    }
                }
            }
        }
        ...
        $mergedPdf->Output('D', "filled_metrology_".$_GET['file']."_form.pdf");
            ...
            if ($res = $result->fetch_assoc()) {
                ...
                if(count($btuBoxInfo) > 0){
                    foreach ($btuBoxInfo as $btuBox){
                        ...
                        $fileName = "filled_de_metrology_".$_GET['file']."_form_{$btuBox['no']}.pdf"; 
                        $outputPath = $tempBtuBoxDir . DIRECTORY_SEPARATOR . $fileName;
                        $pdf->Output('F', $outputPath);
                        $btuBoxFilePath[] = $outputPath;
                    }
        ...
        // Output the merged PDF
        $mergedPdf->Output('D', "filled_de_metrology_".$_GET['file']."_form.pdf");
