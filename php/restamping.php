                ...
                if (!$select_stmt->execute()) {
                    ...
                    if ($record = $result->fetch_assoc()) {
                        ...
                        $insertQuery = "INSERT INTO stamping (
                            ...
                            pin_keselamatan, siri_keselamatan, include_cert, borang_d, borang_e, borang_e_date, cawangan, invoice_no, cash_bill, stamping_type, last_year_stamping_date, stamping_date, 
                            ...
                            notification_period, renewed, duplicate, copy
                        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
