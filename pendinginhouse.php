      ...
      <div class="col-lg-12">
        <div class="card card-primary">
          <div class="card-header">
            <div class="row">
              <div class="col-8"><p class="mb-0" style="font-size: 110%">InHouse Validation Record Pending / Expired Status</p></div>
              <div class="col-2">
                <button type="button" class="btn btn-block btn-sm bg-gradient-danger" id="multiDeactivate" data-bs-toggle="tooltip" title="Cancel Inhouse Validations"><i class="fa-solid fa-ban"></i> Cancel Validations</button>
              </div>
              <div class="col-2">
                <button type="button" class="btn btn-block btn-sm bg-gradient-warning" onclick="newEntry()" data-bs-toggle="tooltip" title="Add New Inhouse"><i class="fa-solid fa-circle-plus"></i> Add New Inhouse</button>
              </div>
...
function newEntry(){
  ...
  for (var i = 1; i <= 10; i++) {
    //Symbol setting
    $("#loadTestingTable").find('#unitSymbolSV'+ i).text('');
    $("#loadTestingTable").find('#unitSymbolCR'+ i).text('');
    $("#loadTestingTable").find('#unitSymbolV'+ i).text('');
    ...
    if (capacityId) {
      $.post('php/getStandard.php', {userID: capacityId}, function(data){
        ...
        if(obj.status === 'success'){
          ...
          let varianceDecimalPoint = varianceString.includes('.') ? varianceString.split('.')[1].length : 0; // Added checking for no decimal point
