...
$(function () {
  ...
  $('#extendModal').find('#jenisAlat').on('change', function(){
    ...
    //   $('#extendModal').trigger('atkLoaded');
    // }
    else if(($('#validator').val() == '10' || $('#validator').val() == '9') && jenisAlatName.includes("ATP (MOTORCAR)")){
    ...
    else if(($('#validator').val() == '10' || $('#validator').val() == '9') && jenisAlatName.includes("ATP-AUTO MACHINE")){
    ...
    else if(($('#validator').val() == '10' || $('#validator').val() == '9') && jenisAlatName.includes("ATP")){
    ...
    else if(($('#validator').val() == '10' || $('#validator').val() == '9') && jenisAlatName.includes("ATN")){
    ...
    else if(($('#validator').val() == '10' || $('#validator').val() == '9') && jenisAlatName.includes("ATE")){
    ...
    else if(($('#validator').val() == '10' || $('#validator').val() == '9') && jenisAlatName.includes("SLL")){
    ...
    else if(($('#validator').val() == '10' || $('#validator').val() == '9') && jenisAlatName.includes("BTU - (BOX)")){
    ...
    else if(($('#validator').val() == '10' || $('#validator').val() == '9') && jenisAlatName.includes("BTU")){
    ...
    //   $('#extendModal').trigger('atkLoaded');
    // }
    else if(($('#validator').val() == '10' || $('#validator').val() == '9') && jenisAlatName.includes("SIA")){
    ...
    else if(($('#validator').val() == '10' || $('#validator').val() == '9') && jenisAlatName.includes("BAP")){
    ...
    else if(($('#validator').val() == '10' || $('#validator').val() == '9') && jenisAlatName.includes("SIC")){
