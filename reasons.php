				...
				<div class="card">
					<div class="card-header">
                        <div class="row">
                            <div class="col-8"></div>
                            <div class="col-2">
                                <button type="button" class="btn btn-block btn-sm bg-gradient-danger" id="multiDeactivate" data-bs-toggle="tooltip" title="Delete Reasons"><i class="fa-solid fa-ban"></i> Delete Reasons</button>
                            </div>
                            <div class="col-2">
                                <button type="button" class="btn btn-block btn-sm bg-gradient-warning" id="addBrand"><i class="fa-solid fa-circle-plus"></i> Add Reasons</button>
                            </div>
                        </div>
                    </div>
					<div class="card-body">
    ...
    $('#multiDeactivate').on('click', function () {
        ...
        if (selectedIds.length > 0) {
            if (confirm('Are you sure you want to cancel these items?')) {
                $.post('php/deleteReason.php', {userID: selectedIds, type: 'MULTI'}, function(data){
                    var obj = JSON.parse(data);
            ...
            alert("Please select at least one reason to delete.");
            $('#spinnerLoading').hide();
        }     
    });
});
