...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Borang Panjang</h1>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
        ...
        <div class="card card-primary">
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-8"></div>
              <div class="col-2">
                <button type="button" class="btn btn-block btn-sm bg-gradient-info" id="exportBorangs" data-bs-toggle="tooltip" title="Export Borang"><i class="fa-solid fa-file-export"></i> Export Borangs</button>
              </div>
              <div class="col-2">
  ...
  var table = $("#weightTable").DataTable({
    ...
    'columns': [
      ...
      },
      {
        ...
        render: function (data, type, row) {
          if (row.cert_price != 0){
            return 'RM ' + parseFloat(row.unit_price).toFixed(2) + '<br>' + 'RM ' + parseFloat(row.cert_price).toFixed(2) + ' (Report)';
          }else{
  ...
  $('#exportExcel').on('click', function () {
    ...
    var customerNoFilter = $('#customerNoFilter').val() ? $('#customerNoFilter').val() : '';
        ...
        if(selectedIds.length > 0){
          ...
          "&customer="+customerNoFilter+"&type=panjang&id="+selectedIds);
        }else{
