...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Validators</h1>
			</div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
				...
				<div class="card">
					<div class="card-header">
                        <div class="row">
                            <div class="col-8"></div>
                            <div class="col-2">
                                <button type="button" class="btn btn-block btn-sm bg-gradient-danger" id="multiDeactivate" data-bs-toggle="tooltip" title="Delete Validators"><i class="fa-solid fa-ban"></i> Delete Validators</button>
                            </div>
                            <div class="col-2">
                                <button type="button" class="btn btn-block btn-sm bg-gradient-warning" id="addMachine"><i class="fa-solid fa-circle-plus"></i> Add Validators</button>
                            </div>
                        </div>
                    </div>
					<div class="card-body">
      ...
      <div class="modal-content">
        <form role="form" id="machineForm">
            <div class="modal-header">
              <h4 class="modal-title">Add Validators</h4>
...
$(function () {
    ...
    $.validator.setDefaults({
        submitHandler: function () {
            $('#spinnerLoading').show();
            $.post('php/validator.php', $('#machineForm').serialize(), function(data){
    ...
    $('#multiDeactivate').on('click', function () {
        ...
        if (selectedIds.length > 0) {
            if (confirm('Are you sure you want to cancel these items?')) {
                $.post('php/deleteValidator.php', {userID: selectedIds, type: 'MULTI'}, function(data){
                    var obj = JSON.parse(data);
            ...
            alert("Please select at least one validator to delete.");
            $('#spinnerLoading').hide();
        }     
    });
});
...
function deactivate(id){
    if (confirm('Are you sure you want to cancel this item?')) {
        $('#spinnerLoading').show();
        $.post('php/deleteValidator.php', {userID: id}, function(data){
            var obj = JSON.parse(data);
