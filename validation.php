      ...
      <div class="col-lg-12">
        <div class="card card-primary">
          <div class="card-header">
            <div class="row">
              <div class="col-10"><p>Other Validation Record Pending / Expired Status </p></div>
              <div class="col-2">
                <button type="button" class="btn btn-block bg-gradient-danger" id="multiDeactivate" data-bs-toggle="tooltip" title="Cancel Other Validations"><i class="fa-solid fa-ban"></i> Cancel Validations</button>
              </div>
              <!-- <div class="col-2">
...
$(function () {
  ...
  var table = $("#weightTable").DataTable({
    ...
    'columns': [
      ...
      //               ')" class="btn btn-danger btn-sm"><i class="fa fa-times" aria-hidden="true"></button></div>';
