...
<?php include 'components/customerDetailsModal.php'; ?>
<?php include 'components/machineDetailsModal.php'; ?>
<?php include 'components/serviceDetailsModal.php'; ?>
<?php include 'components/stampingDetailsModal.php'; ?>
<?php include 'components/feesDetailsModal.php'; ?>
...
$(function () {
  ...
  $.validator.setDefaults({
    submitHandler: function (form) {
      ...
      || $('#customerInfoExtendModal').hasClass('show')
      || $('#machineInfoExtendModal').hasClass('show')
      || $('#feesInfoExtendModal').hasClass('show')
      || $('#invoiceInfoExtendModal').hasClass('show')
      || $('#otherInfoExtendModal').hasClass('show')
      || $('#quotationInfoExtendModal').hasClass('show')
      || $('#serviceInfoExtendModal').hasClass('show')
      || $('#stampingInfoExtendModal').hasClass('show')
      ) {
          ...
          var uRL = $('#extendModal').hasClass('show') ? "php/insertStamping.php" :
                    $('#customerInfoExtendModal').hasClass('show') ? "php/insertStampingCustomerInfo.php" :
                    $('#machineInfoExtendModal').hasClass('show') ? "php/insertStampingMachineInfo.php" :
                    $('#feesInfoExtendModal').hasClass('show') ? "php/insertStampingFeesInfo.php" :
                    $('#invoiceInfoExtendModal').hasClass('show') ? "php/insertStampingInvoiceInfo.php" :
                    $('#otherInfoExtendModal').hasClass('show') ? "php/insertStampingOtherInfo.php" :
                    $('#quotationInfoExtendModal').hasClass('show') ? "php/insertStampingQuotationInfo.php" :
                    $('#serviceInfoExtendModal').hasClass('show') ? "php/insertStampingServiceInfo.php" :
                    $('#stampingInfoExtendModal').hasClass('show') ? "php/insertStampingStampingInfo.php" : "";
