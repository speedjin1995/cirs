				...
				<div class="card">
					<div class="card-header">
                        <div class="row">
                            <div class="col-8"></div>
                            <div class="col-2">
                                <button type="button" class="btn btn-block btn-sm bg-gradient-danger" id="multiDeactivate" data-bs-toggle="tooltip" title="Delete Jenis Alat"><i class="fa-solid fa-ban"></i> Delete Jenis Alat</button>
                            </div>
                            <div class="col-2">
                                <button type="button" class="btn btn-block btn-sm bg-gradient-warning" id="addCapacity"><i class="fa-solid fa-circle-plus"></i> Add Jenis Alat</button>
                            </div>
                        </div>
                    </div>
					<div class="card-body">
            ...
            <div class="modal-body">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="capacity" id="capacity" placeholder="Enter Jenis Alat" required>
                </div>
              </div>
            </div>
    ...
    $('#multiDeactivate').on('click', function () {
        ...
        if (selectedIds.length > 0) {
            if (confirm('Are you sure you want to cancel these items?')) {
                $.post('php/deleteAlat.php', {userID: selectedIds, type: 'MULTI'}, function(data){
                    var obj = JSON.parse(data);
            ...
            alert("Please select at least one jenis alat to delete.");
            $('#spinnerLoading').hide();
        }     
    });
});
